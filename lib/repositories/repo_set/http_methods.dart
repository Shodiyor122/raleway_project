...
import 'package:ralewayapp/utils/uri.dart';
...
class RepositoryUtils {
  ...
  static Future<http.Response> fetchData(
    ...
    return executeRequest(client, endpointUrl, method: 'get', data: data);
  }
  ...
  static Future<http.Response> postData(
    ...
    return executeRequest(client, endpointUrl, method: 'post', data: data);
  }
  ...
  static Future<http.Response> patchData(
    ...
    return executeRequest(client, endpointUrl, method: 'patch', data: data);
  }
  ...
  static Future<http.Response> deleteData(
    ...
    return executeRequest(client, endpointUrl, method: 'delete');
  }
